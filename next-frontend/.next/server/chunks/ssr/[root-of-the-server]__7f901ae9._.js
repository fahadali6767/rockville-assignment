...
(()=>{
    const e = new Error("Cannot find module '../../components/CategoriesModal'");
...
function LoginPage() {
        ...
        try {
            ...
            if (data.user) {
                ...
                if (!data.user.favoriteCategories || data.user.favoriteCategories.length === 0) {
                    ...
                    router.push("/dashboard"); // Redirect to dashboard if favorite categories exist
                }
            } else {
                alert("Login successful, but no user data received!");
                router.push("/dashboard"); // Redirect even if no user data, but log a warning
            }
        } catch (error) {
            alert(error.message);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            showCategoriesModal && userData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(CategoriesModal, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7f901ae9._.js.map